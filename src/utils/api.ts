import { _getUsers, _getPolls, _savePoll, _savePollAnswer } from "./dummy-data";
import { isObject } from "./helpers";

function flattenPoll(poll: any) {
...
function formatPolls(polls: any) {
...
export function savePoll(poll: any) {
  return _savePoll(poll).then((p: any) => flattenPoll(p));
}

export function savePollAnswer(args: any) {
